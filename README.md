...
git clone https://github.com/zarishsphere/zs-svc-medication.git
cd zs-svc-medication
...
See [docs.zarishsphere.com/api/zs-svc-medication](https://docs.zarishsphere.com/api/zs-svc-medication) for the full OpenAPI 3.1 specification.
